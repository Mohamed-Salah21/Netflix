...
var ArabicApp = () => {
  ...
  return createPortal(
      ...
      <div class="arabic-page">
        <BrowserRouter>
            ...
            <div className="container">
              <div className="elements">
                ...
                <h4 className="h4-small">
                  هل انت جاهز للمشاهدة؟ أدخل بريدك الالكتروني <br /> لإنشاء
                  عضويتك أو إعادة تشغيلها
                </h4>
              ...
              <div className="inner-container">
                ...
                <div className="text">
                  <div className="text-container">
                    ...
                    <p>
                      احفظ أعمالك المفضلة بسهولة لتتمكن دائماً من مشاهدة ما
                      تريد.
                    </p>
                  </div>
                </div>
              ...
              <div className="inner-container">
                ...
                <div className="text">
                  <div className="text-container">
                    ...
                    <p>
                      أطلق العنان لأطفالك لخوض معامرات مثيرة مع شخصياتهم
                      المحبوبة في تجربة مخصصة لهم - ومجاناً ضمن عضويتك.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <section className="third-section">
            ...
            <h4 className="h4-large">
              هل أنت جاهزٌ للمشاهدة؟ أدخل بريدك الإلكتروني لإنشاء عضويتك أو
              إعادة تشغيلها.
            </h4>
            <h4 className="h4-small">
    ...
    document.getElementById("arabic-lang-root")
  );
};
